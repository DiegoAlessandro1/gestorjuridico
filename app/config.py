...
try:
    ...
    print("⚠️  Verifique o arquivo .env e a URI de conexão")
    client = None
...
def init_db():
    ...
    try:
        ...
        print(f"⚠️  Não foi possível ajustar índice de OAB: {e}")
